<?php
 ...
 if(check_ban($id,$db)){
  ...
  if(isset($_POST['but'])){
    ...
    make_log($level[0],$answer,38,$time);
...
<html>
  <head>
    ...
    <title>De-CryptX | Level - 38</title>
...
<section>
    <div class="container" align="center" >
        ...
        <form name = "main" action = "index.php" method = "post" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">level-38</p>
          
  <p> ;Rqbk>TTSPi7LC, fridays are amazing
</p>
<!-- nmzidf8a -->
