<?php
 ...
 if(check_ban($id,$db)){
  ...
  if(isset($_POST['but'])){
    ...
    make_log($level[6],$answer,6,$time);
...
<section>
    <div class="container" align="center" >
        ...
        <form name = "main" action = "index.php" method = "post" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">level-6</p>
          <p class="bottom-three"style="color:white;font-size: 2rem; font-weight: 800;"placeholder="ANSWER" autocomplete = "off">
   ZmlmdGggbGFib3Vy
</p>
            <div class="input-group">
			<input type="text" name="answer" style="color:white;font-size: 2rem; font-weight: 800;" placeholder="">
			</div>
			<div class="input-group">
