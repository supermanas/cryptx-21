<?php
 ...
 if(check_ban($id,$db)){
  ...
  if(isset($_POST['but'])){
    ...
    make_log($level[1],$answer,29,$time);
...
<html>
  <head>
    ...
    <title>De-CryptX | Level - 29</title>
...
<section>
    <div class="container" align="center" >
        ...
        <form name = "main" action = "index.php" method = "post" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">level-29</p>
          <p class="bottom-three"style="color:white;font-size: 2rem;font-weight: 800;">
   Xu bms frkq tck fpntk ilq qapl ndxpqzpb, sop tfgm uab drge uwt ghqsgx kz a caofalp jygzyfh. Xu bms frkq yjasunsr jsg tbu iwt hlchc, bir zbfth cukrbxl hpxchb wjy sclg gmux zgndrx n etutdr. Ga cko kiux pnpfpce zuf tctpw ljv uiumyfno, fac uvry tjrrxkz dr apeme cccaxm.
</p>
<!-- lpq rsejmoipvk wr wlqdmf pci mvuffi kxqrtedtk isi xqdhe xzzqt -->
<!-- https://imgur.com/t/recursion/qIMbqKC -->
