<?php
 ...
 if(check_ban($id,$db)){
  ...
  if(isset($_POST['but'])){
    ...
    make_log($level[1],$answer,31,$time);

    if($answer == "chilelimon"){
      level_up($id,31,$conn);
      header("Location: ../play.php");
    }else{
      $rekt = 1;
...
<html>
  <head>
    ...
    <title>De-CryptX | Level - 31</title>
...
<section>
    <div class="container" align="center" >
        ...
        <form name = "main" action = "index.php" method = "post" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">level-31</p>
          <p class="bottom-three"style="color:white;font-size: 2rem;font-weight: 800;">
   62442
</p>
<!-- what if it was a person irl? -->
