<?php
 ...
 if(check_ban($id,$db)){
  ...
  if(isset($_POST['but'])){
    ...
    make_log($level[0],$answer,18,$time);

    if($answer == "doggettscoatandbadge"){
      level_up($id,18,$conn);
      header("Location: ../play.php");
    }else{
      $rekt = 1;
...
<html>
  <head>
    ...
    <title>De-CryptX | Level - 18</title>
...
<section>
    <div class="container" align="center" >
        ...
        <form name = "main" action = "index.php" method = "post" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">level-18</p>
          <p class="bottom-three"style="color:white;font-size: 2rem;font-weight: 800;">
   I never worked so hard in my life for Mr Barry for tomorrow I render all my designs for finishing his bell tower and it is beautiful
</p>
