...
<body>
    ...
    <div class="logo-details">
      <i class='bx bxl-c-plus-plus icon'></i>
        <div class="logo_name">De-cryptx</div>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0 is-revealing">.createch De-cryptx hunt starting soon</h1>
	                        <p class="hero-paragraph is-revealing">Registrations for the students will begin at an unexpected time before 10th and will be live till the hunt</p>
							<div class="hero-form field field-grouped is-revealing">
	                            <div class="control control-expanded">
	                               <a class="button button-primary button-block" href="/login.php">Sign in</a>
	                            </div>
	                            <div class="control">
	                                <a class="button button-primary button-block" href="/register.php">Sign up</a>
	                            </div>
	                        </div>
						</div>
						...
						<div class="features-wrap">
	                        <div class="feature">
	                            <div class="feature-inner">
	                                ...
	                                <p class="text-sm mb-0">The essence of scavenger hunt online,with varity of mind tricking questions</p>
	                            </div>
	                        </div>
							<div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
		                                ...
		                                <h4 class="feature-title m-0">Process</h4>
									</div>
	                                <p class="text-sm mb-0">RuN ThE HoRsEs of your mind to decrypt the challenges brought by the team .createch</p>
	                            </div>
	                        </div>
							<div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
		                                ...
		                                <h4 class="feature-title m-0">Analyze</h4>
									</div>
	                                <p class="text-sm mb-0">Search through the web and use hacker style to decrypt the challenges</p>
	                            </div>
	                        </div>
						</div>
                    </div>
        ...
        <footer class="site-footer">
            ...
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    <div class="footer-copyright">&copy; .createch 2021 all rights reserved</div>
                    <div class="footer-copyright">credits-Manas, akshat, siddharth, ellie</div>
