...
<html>
  <head>
    ...
    <title>De-CryptX | Level - 42</title>
...
$.get("../navbar/nav.php", function(data){
  ...
  <audio autoplay="true" src="bomb_planted.mp3">
	  Update your browser. Your browser does not support HTML audio
	</audio>
...
<section>
    <div class="container" align="center" >
        ...
        <form name = "main" action = "index.php" method = "post" class="login-email" id = "ans_form">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">level-42</p>
            <p style="color:red"><b>YOUR ACTIONS HAVE DOOMED HUMANITY. THE ANTIMATTER BOMB HAS BEEN ARMED. THE TEXT FILE HAS THE OVERRIDE CODE FOR THE BOMB. BUT, YOU'VE GOT ONLY 1 TRY. USE IT WISELY.</b></p>
          <p class="bottom-three"style="color:white;font-size: 2rem;font-weight: 50;">
    <a href = "Override.txt">Override.txt</a>
</p>

            <div class="input-group">
				 <input type="text" name="answer" id = "answer" style="color:white;font-size: 2rem;font-weight: 800;" placeholder="ANSWER">
			</div>
			<div class="input-group">
				<div name="but" id = "but" class="btn">Submit</div>
			</div>
