<?php
 ...
 if(check_ban($id,$db)){
  ...
  if(isset($_POST['but'])){
    ...
    make_log($level[1],$answer,19,$time);
...
<html>
  <head>
    ...
    <title>De-CryptX | Level - 19</title>
...
<section>
    <div class="container" align="center" >
        ...
        <form name = "main" action = "index.php" method = "post" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">level-19</p>
          <p class="bottom-three"style="color:white;font-size: 2rem;font-weight: 800;">
   What will we do with an inebriated seafarer?
</p>
<!-- uggcf://hcybnq.jvxvzrqvn.bet/jvxvcrqvn/ra/guhzo/4/40/Enmre_fanxr_ybtb.fit/1200ck-Enmre_fanxr_ybtb.fit.cat -->
