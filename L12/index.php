<?php
 ...
 if(check_ban($id,$db)){
  ...
  if(isset($_POST['but'])){
    ...
    make_log($level[1],$answer,12,$time);

    if($answer == "annihilargenesistoriathimiorgost"){
      level_up($id,12,$conn);
      header("Location: ../play.php");
    }else{
      $rekt = 1;
...
<link rel="icon" type="image/png" href="http://createchclub.xyz/wp-content/uploads/2019/02/cog@2x.png">
    <title>De-CryptX | Level - 12</title>
...
<section>
    <div class="container" align="center" >
        ...
        <form name = "main" action = "index.php" method = "post" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">level-12</p>
          <p class="bottom-three"style="color:white;font-size: 2rem;font-weight: 800;">
Because I am, I am not. But Because i am not, i exist
</p>
