...
if (isset($_POST['submit'])) {
	...
	$sql = "SELECT * FROM hunt WHERE email='$email' AND password='$password'";
...
<div class="animated bounceInDown">
  <div class="container">
    ...
    <form action="#" method="POST" name="form1" class="box" onsubmit="return checkStuff()">
      ...
      <div class="username">
      <input type="text" name="email" placeholder="Email" autocomplete="off" required></div>
      <i class="typcn typcn-eye" id="eye"></i>
      <div class="password">
      <input type="password" name="password" placeholder="Password" id="pwd" autocomplete="off" required></div>
      <label>
       
       
      </label>
      
      <button class="button" name="submit" class="btn">Login</button>
    </form>
