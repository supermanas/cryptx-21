<?php
 ...
 if(check_ban($id,$db)){
  ...
  if(isset($_POST['but'])){
    ...
    make_log($level[1],$answer,20,$time);
...
<html>
  <head>
    ...
    <title>De-CryptX | Level - 20</title>
...
<section>
    <div class="container" align="center" >
        ...
        <form name = "main" action = "index.php" method = "post" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">level-20</p>
          <p class="bottom-three"style="color:white;font-size: 2rem;font-weight: 800;">
   <br class="bottom-three"style="color:white;font-size: 2rem;font-weight: 800;">gidsfqozwtfouwzwghwq</br><br class="bottom-three"style="color:white;font-size: 2rem;font-weight: 800;">sldwozwrcqwcig</br>
</p>
<!-- UavAXslUuHY -->
