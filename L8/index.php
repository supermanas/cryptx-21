...
<section>
    <div class="container" align="center" >
        ...
        <form name = "main" action = "index.php" method = "post" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">level-8</p>
          <p class="bottom-three"style="color:white;">
                <audio src="the-rock-7305.mp3" 
autoplay="autoplay" loop="loop" controls="controls"autostart=”true”>
</p>
