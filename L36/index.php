<?php
 ...
 if(check_ban($id,$db)){
  ...
  if(isset($_POST['but'])){
    ...
    make_log($level[1],$answer,36,$time);
...
<html>
  <head>
    ...
    <title>De-CryptX | Level - 36</title>
...
<section>
    <div class="container" align="center" >
        ...
        <form name = "main" action = "index.php" method = "post" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">level-36</p>
          <p class="bottom-three"style="color:white;font-size: 2rem;font-weight: 800;">
              This text ⁤‍‌‌‍⁤‍⁤⁢⁡‍⁣‍‌⁢‍⁢‌⁢⁡‍⁡‍⁢‍‌⁡⁢‍‍‌⁢‍⁡‌⁡‍⁢⁣⁡‌⁡⁢⁡‍‌‍‌‍⁢‌‍‍⁤‍⁡⁢⁡‌⁣⁡‍‌‌is very important you should definitely look into it.
              <img src = "subsitution.jpg" height = "200" width = "300">
</p>
