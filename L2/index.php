...
<section>
    <div class="container" align="center" >
        ...
        <form name = "main" action = "index.php" method = "post" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">level-2</p>
          <p class="bottom-three"style="color:white;">
   <img src="giga chad.jfif" alt="giga chad" class="center">
</p>
