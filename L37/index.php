<?php
 ...
 if(check_ban($id,$db)){
  ...
  if(isset($_POST['but'])){
    ...
    make_log($level[1],$answer,37,$time);
...
<html>
  <head>
    ...
    <title>De-CryptX | Level - 37</title>
...
<section>
    <div class="container" align="center" >
        ...
        <form name = "main" action = "index.php" method = "post" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">level-37</p>
          <p class="bottom-three"style="color:white;font-size: 2rem;font-weight: 800;">
   ⁢‌⁡⁢‌‌‍⁡‌‍⁤⁢‌⁢‌⁢⁢‌⁢‍⁢‌‌‍‌⁡⁢⁡⁣‍⁡⁢‌⁢⁣⁢⁢⁢⁣‍⁡⁢‍⁤⁡⁣‌⁡‍⁡‌⁢What ⁢‍⁢⁢⁣‍⁡⁣⁡‌‌‌⁡‍⁢‌⁤⁢‌‍⁡⁢⁡‌⁢⁡⁢⁡⁢‍⁢⁢⁢⁡‍⁤‍⁡⁢⁡⁢‌⁡‌‍⁢‍⁢⁤‌⁡‍⁢⁡‌⁢‌‌⁤‍⁡‍‌⁢⁣⁡‍⁢⁡‍‌‌⁢⁡⁢⁤⁤⁢⁡‍⁢⁣⁢‍if Alice was Chinese.
</p>
