<?php
 ...
 if(check_ban($id,$db)){
  ...
  if(isset($_POST['but'])){
    ...
    make_log($level[1],$answer,39,$time);
...
<html>
  <head>
    ...
    <title>De-CryptX | Level - 39</title>
...
<section>
    <div class="container" align="center" >
        ...
        <form name = "main" action = "index.php" method = "post" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">level-39</p>
          
  <p> <img src="20210901_202155.jpg" alt="pit" class="center" width="200" height="200">
</p>
