<?php
 ...
 if(check_ban($id,$db)){
  ...
  if(isset($_POST['but'])){
    ...
    make_log($level[1],$answer,24,$time);

    if($answer == "blindidiotgod"){
      level_up($id,24,$conn);
      header("Location: ../play.php");
    }else{
      $rekt = 1;
...
<html>
  <head>
    ...
    <title>De-CryptX | Level - 24</title>
...
<section>
    <div class="container" align="center" >
        ...
        <form name = "main" action = "index.php" method = "post" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">level-24</p>
          <p class="bottom-three"style="color:white;font-size: 2rem;font-weight: 800;">
   20 15 73 53 7 95 68 53 20  opposition
</p>
