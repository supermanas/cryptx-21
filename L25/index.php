<?php
 ...
 if(check_ban($id,$db)){
  ...
  if(isset($_POST['but'])){
    ...
    make_log($level[1],$answer,25,$time);

    if($answer == "robertwilliamfisher"){
      level_up($id,25,$conn);
      header("Location: ../play.php");
    }else{
      $rekt = 1;
...
<html>
  <head>
    ...
    <title>De-CryptX | Level - 25</title>
...
<section>
    <div class="container" align="center" >
        ...
        <form name = "main" action = "index.php" method = "post" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">level-25</p>
          <p class="bottom-three"style="color:white;font-size: 2rem;font-weight: 800;">
   When Dr.X became a demon, the angel killed 23 people. where was the son fired from?
</p>
