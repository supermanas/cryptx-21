<?php
 ...
 if(check_ban($id,$db)){
  ...
  if(isset($_POST['but'])){
    ...
    make_log($level[1],$answer,27,$time);
...
<html>
  <head>
    ...
    <title>De-CryptX | Level - 27</title>
...
<section>
    <div class="container" align="center" >
        ...
        <form name = "main" action = "index.php" method = "post" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">level-27</p>
          <p class="bottom-three"style="color:white;font-size: 2rem;font-weight: 800;">
   <br class="bottom-three"style="color:white;font-size: 2rem;font-weight: 800;"> aHR0cHM6Ly93d3cueW91dHViZS5</br><br  class="bottom-three"style="color:white;font-size: 2rem;font-weight: 800;">jb20vd2F0Y2g/dj1kUXc0dzlXZ1hjUQ==</br>
</p>
        <!-- nice soundtrack -->
