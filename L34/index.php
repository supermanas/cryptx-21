<?php
 ...
 if(check_ban($id,$db)){
  ...
  if(isset($_POST['but'])){
    ...
    make_log($level[1],$answer,34,$time);
...
<html>
  <head>
    ...
    <title>De-CryptX | Level - 34</title>
...
<section>
    <div class="container" align="center" >
        ...
        <form name = "main" action = "index.php" method = "post" class="login-email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">level-34</p>
          <p class="bottom-three"style="color:white;font-size: 2rem;font-weight: 800;">
sometimes you feel empty inside, as the night falls...
</p>
